...
var _user$project$Main$eyeGazeServer = 'ws://localhost:8887';
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {input: a, mostRecentGazePoint: b, messages: c};
	});
...
var _user$project$Main$update = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		var _p7 = _p1.mostRecentGazePoint;
		var _p6 = _p1.messages;
		var _p5 = _p1.input;
		var _p2 = A2(_elm_lang$core$Debug$log, 'boop', _p6);
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'NewGazePoint':
				var _p4 = _p3._0;
				return {
					...
					_0: A3(
						...
						{
							ctor: '::',
							_0: _elm_lang$core$Basics$toString(_p4.y),
							_1: _p6
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Send':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Main$Model, '', _p7, _p6),
					_1: A2(_elm_lang$websocket$WebSocket$send, _user$project$Main$eyeGazeServer, _p3._0)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A3(
						...
						_p5,
						_p7,
						{ctor: '::', _0: _p3._0, _1: _p6}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$GazePoint = F4(
	function (a, b, c, d) {
		return {state: a, timestamp: b, x: c, y: d};
	});
var _user$project$Main$gazePointDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'state',
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$GazePoint)))));
...
var _user$project$Main$view = function (model) {
	var right = _elm_lang$core$Basics$toString(model.mostRecentGazePoint.y - 15);
	var left = _elm_lang$core$Basics$toString(model.mostRecentGazePoint.x - 15);
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'left',
							_1: A2(_elm_lang$core$Basics_ops['++'], left, 'px')
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'top',
								_1: A2(_elm_lang$core$Basics_ops['++'], right, 'px')
							},
							_1: {
								ctor: '::',
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$Send('startTracker')),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$Send('stopTracker')),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.mostRecentGazePoint.x)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Beep boop'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Main$NewGazePoint = function (a) {
	return {ctor: 'NewGazePoint', _0: a};
};
var _user$project$Main$receiveMessage = function (payload) {
	var _p8 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$gazePointDecoder, payload);
	if (_p8.ctor === 'Err') {
		var _p9 = A2(_elm_lang$core$Debug$log, 'error msg', _p8._0);
		return _user$project$Main$NewGazePoint(
			{state: -1, timestamp: 0, x: 1, y: 5});
	} else {
		var _p10 = A2(_elm_lang$core$Debug$log, 'payload', payload);
		return _user$project$Main$NewGazePoint(_p8._0);
	}
};
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$eyeGazeServer, _user$project$Main$receiveMessage);
};
